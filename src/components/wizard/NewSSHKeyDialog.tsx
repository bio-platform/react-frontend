import { Button, Dialog, DialogTitle, DialogContent, DialogContentText, Link, DialogActions } from "@material-ui/core";
...
export const NewSSHKeyDialog = ({uploadKey} : NewSSHKeyDialogProps) => {
    ...
    return (<div>
        ...
        <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
            ...
            <DialogContent>
                <DialogContentText>
                    To create RSA key pair, see <Link href="https://git-scm.com/book/en/v2/Git-on-the-Server-Generating-Your-SSH-Public-Key">this</Link> guide. 
            </DialogContentText>
                <NormalTextField
                    autoFocus
                    value={keyName}
