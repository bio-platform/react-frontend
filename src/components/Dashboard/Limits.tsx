...
export const Limits = ({ limit }: Props) => {
    ...
    const limitArray = [
        { name: 'Floating IPs ', used: limit.floating_ips.used, limit: limit.floating_ips.limit },
        { name: 'Instances ', used: limit.instances.used, limit: limit.instances.limit },
    ...
    return (
        <Grid container spacing={3}>
            {limitArray.map((element) => {
                return (
                    <Grid key={element.name} sm={6} md={4} lg={3} item={true}>
